...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [553213.629000, 1274226.477000, 556852.987000, 1278113.515845], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:9209',
            //extent: [553213.629000, 1274226.477000, 556852.987000, 1278113.515845],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([553213.629000, 1274226.477000, 556852.987000, 1278113.515845], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Bản đồ tra cứu giá đất theo bảng giá nhà nước tại Thị trấn Tân Biên</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (344 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '🔹Hướng dẫn sử dụng<br />- Add Layer List: Hiển thị danh sách lớp <br />- Add Measure Tool: Thước đo khoảng cách/diện tích<br />- Add Geolocation: Định vị vị trí người dùng (GPS)<br />- Add layer seach: Tra cứu thửa đất theo số tờ_số thửa <br />🔹 Giá đất được áp dụng theo Quyết định số 54/2024/QĐ-UBND Tỉnh Tây Ninh <br />🔹 Lưu ý: Thông tin chỉ mang tính chất tham khảo <br /><br /><br /><br />';
            }
